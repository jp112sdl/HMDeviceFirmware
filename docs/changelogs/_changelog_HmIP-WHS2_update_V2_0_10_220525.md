...
Device:      HmIP-WHS2 - Homematic IP Switch Actuator for heating systems – 2 channels
...
** New Feature
   * Firmware-Erweiterung erforderlich damit Gerät mit HmIP-FALMOT-C12 gepaired werden kann
   * AppSequenceCounter-Überwachung auf Bereich ausweiten
